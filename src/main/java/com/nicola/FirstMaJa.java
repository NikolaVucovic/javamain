...
public class FirstMaJa {
    ...
    //да понятно что годами джаву учат годами. поэтому и нет вопрсов. тут каждый урок не восторг
    // каждый урок просто обзор. обзоры на то что можно выучит за кучу лет
    //а курсы 3 месяца
